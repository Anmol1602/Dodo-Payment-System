    ...
    <div className="grid grid-cols-1 sm:grid-cols-3 gap-4">
      ...
      <div className="bg-white/5 backdrop-blur-md border border-white/10 rounded-2xl p-5 hover:border-white/20 transition-colors">
        <div className="flex items-center justify-between mb-1">
          <span className="text-xs text-slate-400 uppercase tracking-wider">Total Volume (USD)</span>
        ...
        <div className="text-[11px] text-slate-500 mt-1">Minor units (cents) enforced</div>
      </div>
      ...
      <div className="bg-white/5 backdrop-blur-md border border-white/10 rounded-2xl p-5 hover:border-white/20 transition-colors">
        ...
        <div className="text-[11px] text-slate-500 mt-1">Terminal states immutable</div>
      </div>
      ...
      <div className="bg-white/5 backdrop-blur-md border border-white/10 rounded-2xl p-5 hover:border-white/20 transition-colors">
        ...
        <div className="text-[11px] text-slate-500 mt-1">HMAC-SHA256 signatures verified</div>
      </div>
    </div>
  );
};
